"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\sebba\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.492\\out\\buildHook\\index.js').default({tool: 'angular', checkSum: '209dc2be5a15f31d06b4faCF1NAExUAFsCVAdWCFAJBVMMV1Jc', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/sebba/.vscode/extensions/wallabyjs.console-ninja-1.0.492/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '209dc2be5a15f31d06b4faCF1NAExUAFsCVAdWCFAJBVMMV1Jc', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
